...
from .types import Uint16, Uint32, Uint64, Double
...
class Writer(object):
    ...
    def _adjust_record_size(self):
        ...
        self.data_offset = self.meta.record_size * 2 / 8 * self.meta.node_count
        ...
        with open(fname, "wb") as f:
            for node in self._node_list:
                ...
                if self.meta.record_size == 24:
                    ...
                    b6 = (right_idx >> 8) & 0xFF
                    b7 = right_idx & 0xFF
                    f.write(struct.pack(">BBBBBBB", b1, b2, b3, b4, b5, b6, b7))
            ...
            # Write metadata section. First the magic:
    ...
    def _serialize_value(self, value, use_cache=False):
        ...
        if type(value) is dict:
            ...
            res = self._make_value_header(types.TYPE_BOOLEAN, 1 if value else 0)

        else:
            raise Exception("don't know how to serialize {}".format(type(value)))
